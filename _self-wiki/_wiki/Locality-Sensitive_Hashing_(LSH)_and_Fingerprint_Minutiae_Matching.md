---
title: Locality-Sensitive Hashing (LSH) and Fingerprint Minutiae Matching
last_updated: '2026-05-20T20:45:59.990169'
description: A technical summary detailing the application of LSH algorithms to enhance
  the matching process of fingerprint minutiae data, including the MCC representation.
level: 1
tags:
- algorithms
- technical_theory
...
- type/synthesis
alias: Summary about fingerprint and Locality-Sensitive Hashing Algorithms
---

> This document synthesizes concepts from fingerprint analysis, specifically using Minutia Cylinder-code (MCC) representation, and applies the mathematical framework of Locality-Sensitive Hashing (LSH).
LSH provides a method to efficiently search for near neighbors in high-dimensional data by mapping similar items to the same hash bucket, drastically reducing the required distance calculations.



### Distillation (2026-05-20) - source: [[../raw/diary/2015-03-20-mcc_lsh.md]]
...
## Sources
- [[../raw/diary/2015-03-20-mcc_lsh.md]]
